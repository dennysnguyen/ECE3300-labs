...
HD_PWD='C:/Users/denny/.Xilinx/Projects/8_bit_PASR/8_bit_PASR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eight_bit_PASR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eight_bit_PASR.tcl

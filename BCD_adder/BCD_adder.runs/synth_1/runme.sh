...
HD_PWD='C:/Users/denny/.Xilinx/Projects/BCD_adder/BCD_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcdadd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcdadd.tcl

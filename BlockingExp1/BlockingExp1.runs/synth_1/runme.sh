...
HD_PWD='C:/Users/denny/.Xilinx/Projects/BlockingExp1/BlockingExp1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BlockingExp1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BlockingExp1.tcl

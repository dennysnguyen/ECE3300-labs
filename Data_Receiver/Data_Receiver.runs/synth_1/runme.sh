...
HD_PWD='C:/Users/denny/.Xilinx/Projects/Data_Receiver/Data_Receiver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DataReceiver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DataReceiver.tcl

...
HD_PWD='C:/Users/denny/.Xilinx/Projects/add_sub/add_sub.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bit_add_sub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_bit_add_sub.tcl

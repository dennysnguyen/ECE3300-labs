...
HD_PWD='C:/Users/denny/addern/addern.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log addern.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source addern.tcl
